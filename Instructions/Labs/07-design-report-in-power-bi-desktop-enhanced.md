...
To complete this exercise, first download the [07-enhance-report](https://github.com/MicrosoftLearning/PL-300-Microsoft-Power-BI-Data-Analyst/raw/Main/Allfiles/Labs/07-design-report-in-power-bi-desktop-enhanced\07-enhanced-report.zip) zip folder. Extract the folder named as **07-enhance-report** to the **C:\Users\Student\Downloads** folder. **Leave the folder open for later use.**
